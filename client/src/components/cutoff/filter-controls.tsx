    ...
    <div className="bg-card border border-border rounded-xl p-6 mb-8 animate-fade-in">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <div>
          ...
          >
            <SelectTrigger 
              className="w-full focus:ring-2 focus:ring-emerald-400 focus:border-transparent transition-all duration-300"
              data-testid="filter-institute"
            >
        ...
        <div>
          ...
          >
            <SelectTrigger 
              className="w-full focus:ring-2 focus:ring-pink-400 focus:border-transparent transition-all duration-300"
        ...
        <div>
          ...
          >
            <SelectTrigger 
              className="w-full focus:ring-2 focus:ring-purple-400 focus:border-transparent transition-all duration-300"
